> Atenção:
> a versão atual foi alterada por @hladf (hugo ladeira) para funcionar multi accounts em meia tela com zoom de 67%.
> Não seguir as instruções abaixo e com o zoom de 67% pode causar mal funcionamento do bot.
